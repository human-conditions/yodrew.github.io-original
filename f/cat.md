...
>  I did too many 4-day retreats. It was like getting caught in a whirlpool. I lost too much [*false capacity*](/hygiene#false-capacity) before normal capacity could be restored to compensate. I still suffer from it. I believe I will heal in a proper 8-day retreat.
...
Ease back into your regular life. I mean avoid non-routine activities the first week. You will likely continue to notice effects from the retreat. Due to their dreamlike intensity, I call this phase the aftermath. See [*protocol > post-retreat*](/protocol#post-retreat).

If your location has no running water, it's ok. For a 4-day retreat, it is unnecessary. See [*water*](/water) for a short list of requirements.
...
3. Doing more than three, 4-day retreats rather than quickly advancing to 8-day, medium, and long retreats. This is a very serious no-no, folks. Again, see _4-day retreat_ above and [*hygiene > false capacity*](/hygiene#false-capacity). There, I have understated the matter simply because it cannot be overstated.
...
- activated carbon
- HEPA
- Photo Catalytic Oxydation ([PCO](https://www.sciencedirect.com/science/article/pii/S0926337316308001)) is a new, interesting technology that destroys pollutants at the molecular level. Several companies make filters with it. Prices vary widely. 
...
1. [Copyleft](http://sam.zoy.org/wtfpl) 2009-2015 by [Andrew Durham](/). Copying is an act of [♥](http://copyheart.org). Write me for a print-worthy pdf. Please copy, distribute, and sell (yes, _sell_) this book in its entirety or its industrial applications, ie, darkroom components, in any media or business venture for your own personal gain.
2. I would like credit where due, so I will recognize and link to you on this site if you:
    ...
    2. share suggestions for text or designs by making pull requests or opening issues in my [github repo](https://github.com/yodrew/yodrew.github.io), or sending [*email*](/bio)
...
In 2008, my quest culminated in [_the darkness conjecture_](/darkness-conjecture/). It is the concept of the restful use of darkness in support of the self​-healing psyche. I began:
